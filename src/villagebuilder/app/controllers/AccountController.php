...
class AccountController extends BaseController {
        ...
        if ($validator->fails()) {
            ...
            if ($user) {
                return Redirect::route('home')
                        ->with('global', 'Your account has been activated.  Check you email.');
            }
        }
    ...
    public function postSignIn() {
        ...
        return Redirect::route('account-sign-in')
                ->with('global', 'There was a problem signing in.  Did you activate?');
    }
    ...
    public function postChangePassword() {
        ...
        if ($validator->fails()) {
            ...
            if (Hash::check($old_password, $user->getAuthPassword())) {
                ...
                return Redirect::route('account-change-password')
                    ->with('global', 'The old password entered was incorrect.');
            }
        ...
        if($validator->fails()) {
            ...
            if ($user->count()) {
                ...
                if ($user->save()) {
                    ...
                    return Redirect::route('home')
                            ->with('global', 'Your temporary password has been emailed to you');
                }
    ...
    public function getRecover($code) {
        ...
        if($user->count()) {
            ...
            if ($user->save()) {
                return Redirect::route('home')
                    ->with('global', 'Your account has been recovered.  Please sign in with your temporary password.');
            }
        }     
        return Redirect::route('home')
